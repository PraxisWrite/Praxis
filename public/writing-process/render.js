        ...
        <div class="process-panel-header">
          <div>
            ...
            <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;position:relative;">
              ...
              ${Number(metrics.pasteEventCount || 0) > 0 ? `<span class="process-paste-flag" title="${escapeHtml(String(metrics.pasteEventCount))} paste-like event${Number(metrics.pasteEventCount) === 1 ? "" : "s"} detected while writing — check the timeline pins and the replay.">⚠ Paste flag</span>` : ""}
