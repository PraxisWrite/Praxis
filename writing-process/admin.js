(() => {
  ...
  function summarizeProcessDataPool(detail = {}) {
    ...
    const summary = {
      ...
      analysisVersion: types.ANALYSIS_VERSION || "writing-process-v1",
    };
    ...
    submissions.forEach((submission) => {
      ...
      if (safeArray(submission.writing_events || submission.writingEvents).length) {
    ...
    return `
      <div class="process-admin-panel">
        <div>
          ...
          <h3 style="margin:0;">${escapeHtml(String(summary.includedSubmissions))} included submissions</h3>
